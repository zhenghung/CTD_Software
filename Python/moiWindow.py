...
def moi_start(ser, cs_config, moi_window):
	...
	comStand = Button(instructionFrame, text='MOI Standby', command=standby)
	...
	measureButton1 = Button(buttonFrame,text='Orientation 1 Measure', command=measure1)
	measureButton1.pack(fill=X)
	measureButton2 = Button(buttonFrame,text='Orientation 2 Measure', command=measure2)
	measureButton2.pack(fill=X)
	measureButton3 = Button(buttonFrame,text='Orientation 3 Measure', command=measure3)
	measureButton3.pack(fill=X)
	finishButton = Button(buttonFrame,text='Compute Measurements', command=finish)
